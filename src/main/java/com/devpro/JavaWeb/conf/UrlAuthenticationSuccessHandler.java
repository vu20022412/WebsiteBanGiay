...
public class UrlAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
	 ...
	 * @return
	 */
	protected String determineTargetUrl(final Authentication authentication/*User*/) {
		Map<String, String> roleTargetUrlMap = new HashMap<>();
		roleTargetUrlMap.put("ADMIN", "/admin/product/list");
		roleTargetUrlMap.put("GUEST", "/home");

		final Collection<? extends GrantedAuthority> authorities = authentication.getAuthorities(); //List[Role]
