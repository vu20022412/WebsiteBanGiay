		...
		<div class="main-panel">
			...
			<nav class="navbar navbar-expand-lg " color-on-scroll="500">
				<div class="container-fluid">
					<a class="navbar-brand" href="#pablo"> Quản lý người dùng </a>
			...
			<div class="content">
				<div class="container-fluid">
				<form class="form-inline" action="${base }/admin/user/list" method="get">
					<div class="row">
						
						<div class="col-xxl-12 add" style="padding-bottom: 30px;">
							<a class="btn btn-primary" href="${base }/admin/adduser" role="button">Add
										...
										<tbody>
											<!-- <tr>
                                             ...
                                             <c:forEach items="${users.data }" var="user">
                                                ...
                                                <td>${user.phone }</td>
                                                <td><a class="btn btn-primary" href="${base }/admin/user/management/${user.getId()}" role="button">Sửa</a></td>
                                                <td><a class="btn btn-danger" href="${base }/admin/user/delete/${user.getId()}" role="button">Xóa</a></td>
                                            	</tr>
											</c:forEach>
										</tbody>
									</table>
...
<!--   Core JS Files   -->
<%-- <script src="${base }/js/core/jquery.3.2.1.min.js"
