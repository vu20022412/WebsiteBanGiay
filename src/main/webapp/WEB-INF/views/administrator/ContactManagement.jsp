...
<link href="${base }/css/demo.css" rel="stylesheet" />
</head>
     ...
     -->
			<div class="sidebar-wrapper">
				...
				<ul class="nav">
					...
					<li class="nav-item active"><a class="nav-link" href="${base }/admin/contact">
							<p>Quản lý liên hệ</p>
					</a></li>
		...
		<div class="main-panel">
			...
			<nav class="navbar navbar-expand-lg " color-on-scroll="500">
				<div class="container-fluid">
					<a class="navbar-brand" href="#pablo"> Quản lý liên hệ</a>
						...
						<div class="col-md-12">
							<div class="card strpied-tabled-with-hover">
								<!-- <div class="card-header ">
                                         <h4 class="card-title">Quáº£n lÃ½ tÃ i khoáº£n</h4>
										...
										<tbody>
											<c:forEach items="${contact }" var="contacts">
												<tr>
													...
													<td><a class="btn btn-danger" href="${base }/admin/contact/delete/${contacts.getId() }" role="button">Xóa</a></td>
												</tr>
											</c:forEach>
										</tbody>
									</table>
