            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    <li class="nav-item active">
                        <a class="nav-link" href="${base }/admin/home">
                    ...
                    <li>
                        <a class="nav-link" href="${base }/admin/product/list">
                            
                            <p>Quản lý sản phẩm</p>
                        </a>
                    </li>
                    <li>
                        <a class="nav-link" href="${base }/admin/user/list">
...
<!--   Core JS Files   -->
<script src="${base }/js/core/jquery.3.2.1.min.js" type="text/javascript"></script>
...
<script src="${base }/js/js/plugins/bootstrap-notify.js"></script>
<!-- Control Center for Light Bootstrap Dashboard: scripts for the example pages etc -->
<script src="${base }/js/light-bootstrap-dashboard.js?v=2.0.0 " type="text/javascript"></script>
<!-- Light Bootstrap Dashboard DEMO methods, don't include it in your project! -->
<script src="${base }/js/js/demo.js"></script>
