         ...
         <div class="main-panel">
             ...
             <nav class="navbar navbar-expand-lg " color-on-scroll="500">
                 <div class="container-fluid">
                     <a class="navbar-brand" href="#pablo"> ADD OR UPDATE USER </a>
                         ...
                         <ul class="nav navbar-nav mr-auto">
                             <li class="nav-item">
                                 <a href="#" class="nav-link" data-toggle="dropdown">
                                     <span class="d-lg-none">ADD OR UPDATE USER</span>
                                 </a>
                             </li>
                         </ul>
             ...
             <div class="content">
                <div class="container-fluid">
                    <sf:form modelAttribute="users" action="${base }/admin/user/management/{userId}" method="post">
                    	<div class="row">
	                    	<div class="form-group mb-2">
									<label for="productId">Product User</label>
									<sf:input path="id" id="productId" class="form-control"></sf:input>
							</div>
						</div>
                        <%-- <div class="row">
                            <div class="col-xxl-6" style="padding-bottom: 20px;">
                                <sf:input path="title" type="text" name="title" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="addon-wrapping"></sf:input>
                            </div>
                        </div> --%>

                        <div class="row">
                            <div class="col-xxl-6" style="padding-bottom: 20px;">
                                <sf:input path="username" type="text" name="username" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="addon-wrapping"></sf:input>
                            </div>

                            <div class="col-xxl-6" style="padding-bottom: 20px;">
                                <sf:input path="password" type="text" name="password" class="form-control" placeholder="Password" aria-label="Username" aria-describedby="addon-wrapping"></sf:input>
                            </div>
                            
                        <div class="row">
                            <div class="col-xxl-6" style="padding-bottom: 20px;">
                                <sf:input path="email" type="text" name="title" class="form-control" placeholder="Email" aria-label="Username" aria-describedby="addon-wrapping"></sf:input>
                            </div>
                        </div>
                        
                        <div class="row">
                            <div class="col-xxl-6" style="padding-bottom: 20px;">
                                <sf:input path="Phone" type="text" name="title" class="form-control" placeholder="Phone number" aria-label="Username" aria-describedby="addon-wrapping"></sf:input>
                            </div>
                        </div>
